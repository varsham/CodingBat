...
public String noX(String str) {
  ...
  if (str.charAt(0) != 'x') return str.charAt(0) + noX(str.substring(1));
  else return noX(str.substring(1));
}
// test case 1: ""
// test case 2: "a"
// test case 3: "x"
...
public boolean array6(int[] nums, int index) {
  ...
  // if index refers to last element in array, return whether it's equal to 6
...
public int countHi2(String str) {
  ...
  if (str.length() < 3) return 0;
  int i = 0;
  if (str.charAt(i) != 'x' && str.substring(i, i + 2).equals("hi")) {
    return 1 + countHi2(str.substring(i + 2));
  }
  if (str.charAt(i) == 'x' && str.charAt(i + 1) == 'h' && str.charAt(i + 2) == 'i') {
    return countHi2(str.substring(i + 2));
  }
