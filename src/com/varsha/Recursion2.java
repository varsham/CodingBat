...
public boolean splitArray(int[] nums) {
    return func1(0, 0, 0, nums);
}
public boolean func1(int i, int a, int b, int[] nums) {
  if (i >= nums.length) return (a == b);
  
  return func1(i + 1, a + nums[i], b, nums) || func1(i + 1, a, b + nums[i], nums);
...
public boolean splitOdd10(int[] nums) {
    return func2(0, 0, 0, nums);
}
public boolean func2(int i, int a, int b, int[] nums) {
  if (i >= nums.length) return (a % 10 == 0 && b % 2 != 0) || (a % 2 != 0 && b % 10 == 0);
  
  return func2(i + 1, a + nums[i], b, nums) || func2(i + 1, a, b + nums[i], nums);
...
public boolean func(int i, int a, int b, int[] nums) {
  if (i >= nums.length) return (a == b);
  if (nums[i] % 5 == 0 && nums[i] % 3 != 0) {
    a += nums[i];
    return func(i + 1, a, b, nums);
  }
  if (nums[i] % 3 == 0 && nums[i] % 5 != 0) {
    b += nums[i];
    return func(i + 1, a, b, nums);
  }
  return func(i + 1, a + nums[i], b, nums) || func(i + 1, a, b + nums[i], nums);
